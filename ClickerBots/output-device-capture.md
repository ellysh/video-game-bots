...
3\. Create a source file with `test.cpp` name if you use a MinGW compiler. Create a "Win32 Console Application" project if you use Visual Studio IDE.
